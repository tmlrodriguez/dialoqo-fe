...
const TRANSLATIONS = {
    ...
    "Dialoqo centraliza las comunicaciones de tu organización para escuchar,\n                        observar, interpretar y detectar lo que ocurre en cada conversación.": "Dialoqo centralizes your organization's communications to listen, observe, interpret, and detect what happens in every conversation.",
    "Dialoqo centraliza las comunicaciones de tu organización para escuchar, observar, interpretar y detectar lo que ocurre en cada conversación.": "Dialoqo centralizes your organization's communications to listen, observe, interpret, and detect what happens in every conversation.",
    ...
    "Usuarios autorizados para utilizar las funciones de monitoreo.": "Users authorized to use monitoring functions.",
    ...
    "Supervise las conversaciones de WhatsApp autorizadas para su usuario.": "Monitor the WhatsApp conversations authorized for your user.",
    ...
    "Cree el primer monitor para posteriormente asignarle acceso a empresas.": "Create the first monitor so you can later assign company access.",
    ...
    "Modifique la información de la sucursal seleccionada.": "Modify the selected branch information.",
    ...
    "Modifique la información del monitor seleccionado.": "Modify the selected monitor information.",
    ...
    "Modifique la información del miembro seleccionado.": "Modify the selected member information.",
    ...
    "Auditoría del sistema": "System auditing",
    ...
    "Seleccione un evento para consultar su detalle completo.": "Select an event to view its complete details.",
    ...
    "No fue posible validar el número contra Meta.": "Unable to validate the number against Meta.",
    ...
    "Cree el contexto de conexión de esta empresa con la plataforma Meta utilizada por Dialoqo.": "Create this company's connection context with the Meta platform used by Dialoqo.",
    ...
    "Dialoqo utilizará su aplicación y credenciales globales de Meta para establecer el contexto de conexión.": "Dialoqo will use its global Meta app and credentials to establish the connection context.",
    ...
    "Última desconexión": "Last disconnection",
    ...
    "Registre una cuenta de WhatsApp Business para comenzar.": "Register a WhatsApp Business account to begin.",
    ...
    "Estado real sincronizado mediante la plataforma Meta.": "Actual status synchronized through the Meta platform.",
    "Identificador de WhatsApp Business Account": "WhatsApp Business Account identifier",
    "Identificador de Meta Business": "Meta Business identifier",
    ...
    "Sucursal del número": "Number branch",
    ...
    "Limpiar": "Clear",
    "Aplicar": "Apply",
    "No existen plantillas.": "No templates exist.",
    ...
    "No fue posible cargar los accesos.": "Unable to load access.",
    ...
    "Seleccione una empresa para comenzar.": "Select a company to begin.",
    "Seleccione una sucursal para continuar.": "Select a branch to continue.",
    "Seleccione un número para comenzar a monitorear.": "Select a number to begin monitoring.",
    ...
    "Activar monitoreo": "Activate monitoring",
